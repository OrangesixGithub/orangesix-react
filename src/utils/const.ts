...
export const BASE: string | null = url === null ? null : url.substr(-1) === "/" ? url.slice(0, url.length - 1) : url;
...
export const TOKEN: string | null = token === null ? null : token.content;
...
export const USER: string | null = user === null ? null : user.content;
